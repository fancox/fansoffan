        ...
        <div className="content">
          ...
          <div className="row">
            <HomePageCard imageLink="img/sukiyaki.jpg"
                          ...
                          preparationTime="10 min"
                          cookingTime="15 min"/>
            <HomePageCard imageLink="img/muffin.jpg"
                          articleTitle="Banana Crumb Muffins"
                          articleLink="/blog?id=muffin"
                          preparationTime="15 min"
                          cookingTime="20 min"/>
            <HomePageCard imageLink="img/steak.jpg"
                          articleTitle="Steak"
                          articleLink="/blog?id=steak"
                          preparationTime="20 min"
                          cookingTime="10 min"/>
          </div>
          <div className="row">
            <HomePageCard imageLink="img/burger.jpg"
                          articleTitle="Burger"
                          articleLink="/blog?id=burger"
                          preparationTime="15 min"
                          cookingTime="20 min"/>
            <HomePageCard imageLink="img/curry.jpg"
                          articleTitle="Curry"
                          articleLink="/blog?id=curry"
                          preparationTime="15 min"
                          cookingTime="20 min"/>
          </div>
          {/*add new stuff here*/}
